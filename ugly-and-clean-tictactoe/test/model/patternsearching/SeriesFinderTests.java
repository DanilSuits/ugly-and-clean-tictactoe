...
public class SeriesFinderTests extends TestCase {
	...
	public void testFindsOneHorizontalSeriesOfThree() throws Exception {
		allSeriesFound = seriesFinder.getAllSeriesOfSize(SeriesSize.THREE, Board.THEIR_PLAYER_MARK);
		assertEquals(1, allSeriesFound.size());
		
		ISeries seriesFound = allSeriesFound.get(0);
		assertEquals(Board.getSingleCoordValueFor(5, 0), seriesFound.getStartingBlockingPosition());
		assertEquals(Board.getSingleCoordValueFor(5, 4), seriesFound.getEndingBlockingPosition());
	}
	...
	public void testOnlyStartingBlockingPositionIsOpen() throws Exception {
		...
		ISeries seriesFound = allSeriesFound.get(0);
		assertEquals(Board.getSingleCoordValueFor(4, 4), seriesFound.getStartingBlockingPosition());
	...
	public void testFindsOneHorizontalSeriesOfFour() throws Exception {
		...
		allSeriesFound = seriesFinder.getAllSeriesOfSize(SeriesSize.FOUR, Board.THEIR_PLAYER_MARK);
		assertEquals(1, allSeriesFound.size());
		
		ISeries seriesFound = allSeriesFound.get(0);
		assertEquals(Board.getSingleCoordValueFor(5, 0), seriesFound.getStartingBlockingPosition());
		assertEquals(Board.getSingleCoordValueFor(5, 5), seriesFound.getEndingBlockingPosition());
	}
	
	public void testFindsOneHorizontalSeriesOfTwo() throws Exception {
		board.setPosition(5,3, Board.EMPTY);
		allSeriesFound = seriesFinder.getAllSeriesOfSize(SeriesSize.TWO, Board.THEIR_PLAYER_MARK);
		assertEquals(1, allSeriesFound.size());
		
		ISeries seriesFound = allSeriesFound.get(0);
		assertEquals(Board.getSingleCoordValueFor(5, 0), seriesFound.getStartingBlockingPosition());
		assertEquals(Board.getSingleCoordValueFor(5, 3), seriesFound.getEndingBlockingPosition());
	}
	
	public void testFindOneHorizontalAndOneVerticalSeriesOfThree() throws Exception {
		...
		assertEquals(Board.getSingleCoordValueFor(3, 1), seriesFound.getStartingBlockingPosition());
		assertEquals(Board.getSingleCoordValueFor(7, 1), seriesFound.getEndingBlockingPosition());
	}
	
	public void testFindOneHorizontalAndOneVerticalSeriesWithNoStartingBlockingPosition() throws Exception {
		...
		ISeries seriesFound = allSeriesFound.get(1);
		assertEquals(-1, seriesFound.getStartingBlockingPosition());
		assertEquals(Board.getSingleCoordValueFor(3, 3), seriesFound.getEndingBlockingPosition());
	}

	public void testFindOneHorizontalAndOneDiagonalDownSeriesWithNoEndingBlockingPosition() throws Exception {
		...
		ISeries seriesFound = allSeriesFound.get(1);
		assertEquals(Board.getSingleCoordValueFor(6, 6), seriesFound.getStartingBlockingPosition());
		assertEquals(-1, seriesFound.getEndingBlockingPosition());
	}
	
	public void testFindOneHorizontalAndOneDiagonalUpSeriesOfThree() throws Exception {
		...
		ISeries seriesFound = allSeriesFound.get(1);
		assertEquals(Board.getSingleCoordValueFor(3, 6), seriesFound.getStartingBlockingPosition());
		assertEquals(-1, seriesFound.getEndingBlockingPosition());
	}
	
	public void testFindOneHorizontalSeriesOfThreeInMixedList() throws Exception {
		...
		ISeries seriesFound = allSeriesFound.get(0);
		assertEquals(-1, seriesFound.getStartingBlockingPosition());
		assertEquals(Board.getSingleCoordValueFor(4, 8), seriesFound.getEndingBlockingPosition());
	}
	
	public void testIgnoresHorizontalSeriesOfThreeWithNoPentaRoom() throws Exception {
