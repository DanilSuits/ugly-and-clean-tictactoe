...
public class MoveGroupTests extends TestCase {
	...
	public void testOnlyNonNegativeMovePositionsAndScoresAreStored() throws Exception {
		assertEquals(9, moveGroup.size());
		ArrayList<Move> allMoves = moveGroup.getAllMoves();
		assertEquals(9, allMoves.size());
	}
	
	public void testGetBestMoveIsHighestScoringMoveThatRepeatsMostTimes() throws Exception {
	...
	public void testHighestScoringSingleMove() throws Exception {
		...
		assertEquals(13, moveGroup.getFirstHighestScoringSingleMove().getPosition());
	}
	...
	public void testbestScoringMoves() throws Exception {
		...
		bestScoringMoves = moveGroup.getAllMovesWithSameScoreAsHighestScoringMove(allMoves, highestScoringMove);
	...
	public void testMoveFrequentlyOccurringMoves() throws Exception {
		...
		Move mostFrequentlyRepeatingMove = moveGroup.findMoveThatRepeatsMost(bestScoringMoves);
	...
	public void testGetTwoBirdsMove() throws Exception {
		...
		Move twoBirdsMove = moveGroup.getTwoBirdsMove(highestScoringMove, allMoves);
