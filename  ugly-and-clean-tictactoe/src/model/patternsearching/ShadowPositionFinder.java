...
public class ShadowPositionFinder {
	...
	private IndexListGroup getAllIndexListGroups() {
		IndexListFactory listFactory = new IndexListFactory();
		IndexListGroup allIndexLists = listFactory.getAllIndexLists();
