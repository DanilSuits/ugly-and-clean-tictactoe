...
public class IndexListFactory {
	//TODO Yow. You think maybe these guys could use some tests for different MAX_COLUMN and MAX_ROW values?  :-;
	...
	private static final int FIRST_SQUARE_OF_FIRST_LOWER_DIAG_DOWN_WITH_PENTE_ROOM = (Board.MAX_ROWS - 5) * Board.MAX_COLUMNS ;  
	...
	public IndexListGroup getIndexDiagonalDownsWithPentaRoom(IndexListGroup listGroup) {
	...
	private void assembleUpperBoardDiagonalDownsWithPentaRoom(IndexListGroup listGroup) {
		int currentDiagonalDownSize = 9;
		
		for (int diagonalGroup = 1; diagonalGroup < 6; diagonalGroup++) {
			IndexList list = new IndexList();
			
			getAllSpacesInThisUpperBoardDiagonalDown(currentDiagonalDownSize, diagonalGroup, list);
			listGroup.add(list);
			currentDiagonalDownSize--;
		}
	}

	private void getAllSpacesInThisUpperBoardDiagonalDown(int currentDiagonalDownSize, int diagonalGroup, IndexList list) {
		int spaceIndex;
	...
	private int assembleLowerBoardDiagonalDownsWithPentaRoom(IndexListGroup listGroup) {
		int currentDiagonalDownSize = 5;
		
		for (int diagonalGroup = FIRST_SQUARE_OF_FIRST_LOWER_DIAG_DOWN_WITH_PENTE_ROOM; 
				diagonalGroup > -1; diagonalGroup = diagonalGroup - VERTICAL_AFTER_INCREMENT) {
			IndexList list = new IndexList();
			
			getAllSpacesInThisLowerBoardDiagonalDown(currentDiagonalDownSize, diagonalGroup, list);
	...
	private void getAllSpacesInThisLowerBoardDiagonalDown(int currentDiagonalDownSize, int diagonalGroup, IndexList list) {
		int spaceIndex;
		for (int space = 0; space < currentDiagonalDownSize; space++) {
			spaceIndex = diagonalGroup + (space * DIAGONAL_DOWN_AFTER_INCREMENT);
	...
	private void assembleLowerBoardDiagonalUps(IndexListGroup listGroup) {
		...
		for (int diagonalGroup = FIRST_SQUARE_OF_FIRST_LOWER_BOARD_DIAG_UP_WITH_PENTE_ROOM; 
				diagonalGroup <= FIRST_SQUARE_OF_LAST_LOWER_BOARD_DIAG_UP_WITH_PENTE_ROOM; diagonalGroup++) {
			IndexList list = new IndexList();
			
			getAllSpacesInThisLowerBoardDiagonalUp(currentDiagonalUpSize, diagonalGroup, list);
	...
	private void getAllSpacesInThisLowerBoardDiagonalUp(int currentDiagonalUpSize, int diagonalGroup, IndexList list) {
		int spaceIndex;
	...
	private int assembleUpperBoardDiagonalUps(IndexListGroup listGroup) {
		...
		for (int diagonalGroup = FIRST_SQUARE_OF_FIRST_UPPER_BOARD_DIAG_UP_WITH_PENTE_ROOM; 
				diagonalGroup < Board.MAX_BOARD_SIZE; diagonalGroup = diagonalGroup + VERTICAL_AFTER_INCREMENT) {
			IndexList list = new IndexList();
			
			getAllSpacesInThisUpperBoardDiagonalUp(currentDiagonalUpSize, diagonalGroup, list);
			listGroup.add(list);
			currentDiagonalUpSize++;
		}
	...
	private void getAllSpacesInThisUpperBoardDiagonalUp(int currentDiagonalUpSize, int diagonalGroup, IndexList list) {
		int spaceIndex;
		for (int space = 0; space < currentDiagonalUpSize; space++) {
			spaceIndex = diagonalGroup - (space * DIAGONAL_UP_BEFORE_INCREMENT);
